...
public class SponsorBlockStatsPreferenceCategory extends PreferenceCategory {
    ...
    protected void onAttachedToActivity() {
        try {
            ...
            if (enabled) {
                loadingPlaceholderPreference.setTitle(str("morphe_sb_stats_loading"));
                ...
                loadingPlaceholderPreference.setTitle(str("morphe_sb_stats_sb_disabled"));
            }
        } catch (Exception ex) {
    ...
    private void addUserStats(Preference loadingPlaceholder, @Nullable UserStats stats) {
        ...
        try {
            if (stats == null) {
                loadingPlaceholder.setTitle(str("morphe_sb_stats_connection_failure"));
                return;
            }
            removeAll();
    ...
    private void addLocalUserStats() {
        ...
        preference.setOnPreferenceClickListener(preference1 -> {
            Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                    ...
                    str("morphe_sb_stats_self_saved_reset_title"), // Title.
                    null, // No message.
                    null, // No EditText.
                    null, // OK button text.
                    () -> {
