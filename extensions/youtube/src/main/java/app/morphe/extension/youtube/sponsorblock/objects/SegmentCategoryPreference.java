...
import static app.morphe.extension.youtube.sponsorblock.SponsorBlockSettings.migrateOldColorString;
...
public class SegmentCategoryPreference extends ColorPickerPreference {
    ...
    protected void onDialogOkClicked() {
        if (selectedDialogEntryIndex >= 0 && entryValues != null) {
            ...
            category.setBehaviour(Objects.requireNonNull(CategoryBehaviour.byMorpheKeyValue(value)));
